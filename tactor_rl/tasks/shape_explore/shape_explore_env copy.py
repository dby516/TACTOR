...
#         print("robot cfg: ", self.cfg.robot_cfg)
...
#         obj_path = f"/World/envs/env_.*/Object"
#         env_path = f"/World/envs/env_.*"
#         joint_name = f"fixedJoint_env_.*"
#         sim_utils.add_fixed_joint_to_world(stage, env_path, obj_path, joint_name)
