...
.. code-block:: bash
    run headlessly:
    .external_tools/IsaacLab/isaaclab.sh -p scripts/play.py --headless
    livestreaming with WebRTC:
    .external_tools/IsaacLab/isaaclab.sh -p scripts/play.py --livestream 2
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # -- Object
    cfg = sim_utils.UsdFileCfg(usd_path=f"../objects/object_id/object_id.usd")
    cfg.func("/World/Origin0/Object", cfg, translation=(0.0, 0.0, 0.8))
