...
import data.ShapeNetCore as ShapeNetCore
import results
...
import argparse
"""
Extract URDFs from the ShapeNetCore dataset and store vertices and faces in a dictionary.
"""
...
def load_objects(dataset):
    ...
    if dataset=='PartNetMobility':
        ...
        obj_dir = os.path.dirname(ShapeNetCore.__file__)
        # List all the objects
...
if __name__=='__main__':
    ...
    parser.add_argument(
        "--dataset", default='ShapeNetCore', type=str, help="Dataset used: 'ShapeNetCore'"
    )
